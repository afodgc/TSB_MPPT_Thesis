...
\univlogo{2cm}{2cm}{./Images/Cover/IST_A_RGB_POS.png}
% OPTIONAL IMAGE:
...
\thesislogo{2.5cm}{9cm}{./Images/Cover/SR03_Monaco.jpg}
...
% REQUIRED: Thesis 
\title{Fast response MPPT charger for the Técnico Solar Boat }
