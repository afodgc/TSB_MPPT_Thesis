...
\subsubsection{Transistor and gate driver}
    \textcolor{blue}{Já posso escrever}
    ...
    \subsection{Simulations}
        ...
        \subsubsection{Solar Panel model}
            \textcolor{blue}{Já posso escrever}
            The simulations started at LTspice with the aim to test the converter at different conditions. To achieve that, a \ac{pv} electrical model of the cells were designed using 1M5P configuration. There are more electrical models that can simulate a solar panel, some with more accuracy but more complex. This model was perfect for the aim of the simulation since it is both reliable and simple.

            \textcolor{red}{escrever uma explicação do modelo}

            \textcolor{red}{tirar uma print com as contas}
                \begin{figure}[!ht]
                    \centering
        ...
        \subsubsection{Boost Converter}
            \textcolor{blue}{Já posso escrever} \textcolor{red}{Describe the simulation}
            ...
            \textcolor{red}{Analysis of losses}
\clearpage
...
\subsection{Voltage and current sensing}
    \textcolor{blue}{Já posso escrever} \textcolor{red}{Opções, opção usaada, resolução}
...
\section{PCB design}
    ...
    \subsection{Pre charge}
        \textcolor{blue}{Já posso escrever} \textcolor{red}{como funciona, pq que é preciso, comentários sobre o design}