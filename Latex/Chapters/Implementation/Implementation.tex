...
\section{Software}
    ...
    \subsection{Firmware}
        ...
        \begin{figure}[!ht]
            \centering
            \includegraphics[width=0.6\textwidth]{Images/Implementation/Block diagram-MPPT_flowchart.drawio.pdf}
            \caption{.}
            \label{fig:}
        \end{figure}
        ...
        \begin{figure}[!ht]
            \centering
            \includegraphics[width=0.6\textwidth]{Images/Implementation/Block diagram-MPPT_state_machine.drawio.pdf}
            \caption{.}
            \label{fig:}
        \end{figure}
    ...
    \subsection{Graphical User Interface}
        \textcolor{red}{Funcionalidade, protocoolo de comunicação, como  foi feita, Qt widget, etc.}
