    ...
    \subsection{Simulations}
        ...
        \label{subsubsect:Sim_Boost}
            ...
            \begin{figure}[!ht]
                ...
                \caption{CC-CV charge characteristics and case selection with Vmpp = 21.595~V.}
                \label{}
            \end{figure}
