...
\section{Software}
    ...
    \subsection{Firmware Overview}
        ...
        \textcolor{red}{Atualizar flowcharts. Explicar que o no load previne o uso de um precharge.}
