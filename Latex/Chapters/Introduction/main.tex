...
% \textcolor{red}{Added:} In the context \ac{tsb} project, a \ac{mppt} is specially important to increase the autonomy of our vessels. For example in 2023/24 season we were able to consume only 300~W with \ac{sr03} which had motor of 1.5~KW. Decreasing 80~\% of his consumption with the addition of solar panels. However, we believed that by acquiring more data about our solar panels, we would be able to make better decisions during races and improve the manufacture of our solar panels.

% Now in 2025/26 season, the relevancy of the solar system decreased drastically with the new vessel (São Gabriel 01) since it uses a motor with 130~KW peak and around 20~KW constant power. So the main power source will be hydrogen. However, solar energy will continue to be used in this vessel to power the auxiliary systems being a relabeling green source that will keep the boat alive in all situations.
