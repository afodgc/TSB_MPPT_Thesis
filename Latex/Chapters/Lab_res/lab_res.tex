...
\section{Assembly and first iteration}
    ...
    \textcolor{red}{talk about altium andthe design of the PCB}
...
\section{MPPT}
    ...
    \subsection{Tracking speed}
        ...
        \textcolor{red}{Add a test with $1000w/m^2$ e 25ºC, reudz para $100w/m^2$, volta a aumentar para $1000w/m^2$, aumenta para 85ºC}
