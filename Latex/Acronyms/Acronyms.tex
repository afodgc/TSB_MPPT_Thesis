...
\begin{acronym}[H.264/mppt]
    ...
    \acro{ccm}[CCM]{Continuos Conduction Mode}
    \acro{cv}[CV]{Constant Voltage}
    \acro{dc}[DC]{Direct Current}
    \acro{dcm}[DCM]{Discontinuous Conduction Mode}
    \acro{esl}[ESL]{Equivalent Series Inductance}
    ...
    \acro{sg01}[SG01]{São Gabriel 01}
    \acro{sr03}[SR03]{São Rafael 03}
