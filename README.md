...
This repo contains Afonso Coelho master thesis named "Fast response MPPT switched charger for the Técnico Solar Boat". 

PDF file: [Link](Main_Document.pdf)

Along side with this document it is useful to read the 2nd Cycle Integrated Project in Electrical and Computer Engineering (PIC2) which summarizes the research made after starting the thesis.

PIC2 repo: [Link](https://github.com/afodgc/PIC2.git)
